    ...
    translation: {
      ...
      orders: {
        ...
        filters: {
          ...
          channel_pos: 'POS',
          channel_orders: 'Manual',
          payment_all: 'All payments',
          date_all: 'All time',
          date_today: 'Today',
          date_week: 'This week',
          date_month: 'This month',
          no_match: 'No orders match the active filters.',
          reset: 'Reset filters'
        },
        actions: {
          view: 'View',
          download_receipt: 'Download receipt',
          refund: 'Refund (coming soon)'
        },
        detail: {
          title: 'Order detail',
          order_id: 'Order ID',
          ...
          tax: 'Tax',
          total: 'Total',
          no_items: 'No item snapshot found for this order.',
          loading_items: 'Loading items...',
          refund_notice: 'Refunds and returns require an admin workflow that ships in a later release.'
        },
        empty: {
    ...
    translation: {
      ...
      orders: {
        ...
        filters: {
          ...
          channel_pos: 'POS',
          channel_orders: 'Manual',
          payment_all: 'Todos los pagos',
          date_all: 'Todo el tiempo',
          date_today: 'Hoy',
          date_week: 'Esta semana',
          date_month: 'Este mes',
          no_match: 'Ningún pedido coincide con los filtros activos.',
          reset: 'Limpiar filtros'
        },
        actions: {
          view: 'Ver',
          download_receipt: 'Descargar recibo',
          refund: 'Reembolso (próximamente)'
        },
        detail: {
          ...
          tax: 'Impuestos',
          total: 'Total',
          no_items: 'No hay snapshot de artículos para este pedido.',
          loading_items: 'Cargando artículos...',
          refund_notice: 'Los reembolsos y devoluciones requieren un flujo de admin que llega en una versión posterior.'
        },
        empty: {
